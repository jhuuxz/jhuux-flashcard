criaCartao(
    ...
    'As principais causas foram as condições do tratado de Versalhes, a ascensão do nazismo, facismo e militarismo japonês'
)
...
criaCartao(
    ...
    'O estopim foi a invasão da Polônia pela Alemanha em 1 de setembro de 1939.'
)
...
criaCartao(
    ...
    'Enviou tropas para lutar ao lado dos aliados na Itália'
)
...
criaCartao(
    ...
    'Foi o extermínio de cerca de seis milhões de judeus e outras minorias etnicas e sociais pelos nazistas.'
)
...
criaCartao(
    ...
    'Alemanha se rendeu em 8 de maio de 1945, e o Japão se rendeu em 2 de setembro de 1945 após os bombardeios atômicos de Hiroshima e Nagasaki.'
)
